...
WHERE project_name = ?''', data = (project_name,) )
    ...
    def get_project_info(self, user_id, project_name):
        sql = """
SELECT project_name, description, url, status_name FROM projects JOIN status ONstatus.status_id = projects.status_id)WHERE project_name=? AND user_id=?"""
...
if __name__ == '__main__':
    ...
    manager.insert_project([(1, 'Discord Bot', "www.google.com" , 2),(1,'API',"www.google.com", 3)])
    manager.delete_project(1,2)